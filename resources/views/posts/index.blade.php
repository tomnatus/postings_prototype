    ...
    <div class="flex justify-center">
        <div class="w-8/12 bg-white p-6 rounded-lg shadow-lg">
            ...
            <div class="mb-4">
                ...
                <textarea name="body" id="body" cols="30" rows="5" class="
        ...
        @if ($posts->count())
            @foreach ($posts as $post)
                <div class="mb-4">
                    <a href="" class="font-bold mr-5">{{ $post->user->name }}</a><span class="text-gray-400 text-sm">{{ $post->created_at->diffForHumans() }}</span>
